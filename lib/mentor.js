...
mentor = function(dbName,collectionName,done,error){
	...
	initDatabase.apply(this,[dbName, collectionName, done, error]);
...
function initDatabase(dbName,collectionName,done,error){
	var self = this;
	self.collectionName = collectionName;
	error = error || function(whatever){return null};
	try {
...
mentor.prototype.save = function(){
	...
	// Upsert the current recordset
	var criteria = {_id: this.lessons._id};
	this.db.collection(this.collectionName).update(criteria, this.lessons, {upsert:true},
	 	function(err,result){
			if (err) {
